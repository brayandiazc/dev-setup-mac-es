...
afecte a varias partes del proyecto, o que tu yo futuro (o un nuevo integrante)
agradecerá tener documentada. Ejemplos aquí: elegir el método de instalación de
una herramienta, adoptar un gestor de versiones, cambiar el orden de los scripts.
...
| [0002](0002-gestores-de-version-por-lenguaje.md)             | Gestores de versión por lenguaje                | Aceptada |
| [0003](0003-apps-de-escritorio-para-postgres-y-docker.md)    | Apps de escritorio para PostgreSQL y Docker     | Aceptada |
